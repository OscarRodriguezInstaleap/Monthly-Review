...
def map_by_country(unified: pd.DataFrame, make_forecast, plot_series_with_forecast):
    ...
    fig.update_layout(height=480, margin=dict(l=10,r=10,t=10,b=0), dragmode="zoom")
    ...
    sel_country = st.selectbox("País", all_countries, index=(all_countries.index(sel_country) if sel_country in all_countries else 0))
